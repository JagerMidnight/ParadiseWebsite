export const icyVeinsClassData = [];

export const wowheadClassData = [];
...
export function setupClassTab(icyVeinsData, wowheadData) {
    setupGuideSection(
        'exploreIcyVeinsClassBtn',
        'icyVeinsClassCardsSection',
        'icyVeinsClassSearch',
        'icyVeinsClassCardsGrid',
        'noIcyVeinsClassResults',
        icyVeinsData
    );

    setupGuideSection(
        'exploreWowheadClassBtn',
        'wowheadClassCardsSection',
        'wowheadClassSearch',
        'wowheadClassCardsGrid',
        'noWowheadClassResults',
        wowheadData
    );
}
